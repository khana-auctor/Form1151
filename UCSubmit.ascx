<%@ Control Language="vb" MaintainScrollPositionOnPostback="true"  AutoEventWireup="false" CodeBehind="UCSubmit.ascx.vb" Inherits="DOTForm1151.UCSubmit" %>
...
<asp:Panel ID="SubmitSection" runat="server" Width="884" Height="10px">
  ...
  <div style="border: none;">
    ...
    <asp:DropDownList ID="ReviewAction" runat="server" AutoPostBack="true" CssClass="aerial-font"
      Height="24px" Style="font-family: Arial; font-size: small" Width="157px">
  ...
  Text="Submit" Width="74px" OnClientClick="console.log('Button clicked - postback should follow'); return true;" OnClick="SubmitButton_Click" />
  </div>
  <div>
...
<%--    <asp:TextBox ID="ConsultAction" runat="server" CssClass="aerial-font-small" Width="157px" ReadOnly="true"
    ...
    &nbsp;
    <asp:DropDownList ID="drpConsultUser" runat="server" CssClass="aerial-font-small" AutoPostBack="true"
